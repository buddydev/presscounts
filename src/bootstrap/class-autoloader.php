<?php
/**
 * WP Skeleton Autoload Implementation.
 *
 * @package    PressCounts
...
/**
 * Auto Loader for PressCounts.
 *
 * After registering this autoload function with SPL, the following line
 * would cause the function to attempt to load the PressPeople\PressCounts\Bar\Baz\Qux class
 * from /path/to/wp-content/plugins/wp-skeleton/src/bar/baz/class-qux.php:
 *
 *      new PressPeople\PressCounts\Baz_Xyz\Qux;
 *  maps to /path/to/wp-content/plugins/wp-skeleton/src/bar/baz-xyz/class-qux.php
...
class Autoloader {
	...
	/**
	 * Namespace root. eg. PressPeople\PressCounts\\(escaped slashes);
	 *
	 * @var string
	 */
